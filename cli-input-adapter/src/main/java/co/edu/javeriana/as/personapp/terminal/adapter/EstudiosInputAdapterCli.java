...
public class EstudiosInputAdapterCli {
    ...
    public void crearEstudios(EstudiosModelCli estudiosModelCli) {
        try {
            Person person = personInputPort.findOne(estudiosModelCli.getPersonaId());
            Profession profession = professionInputPort.findOne(estudiosModelCli.getProfesionId());
            Study study = studyInputPort
                    .create(estudiosMapperCli.fromAdapterToDomainCli(estudiosModelCli, person, profession));
    ...
    public void editarEstudios(EstudiosModelCli estudiosModelCli) {
        try {
            Person person = personInputPort.findOne(estudiosModelCli.getPersonaId());
            Profession profession = professionInputPort.findOne(estudiosModelCli.getProfesionId());
            Study study = studyInputPort.edit(estudiosModelCli.getProfesionId(), estudiosModelCli.getPersonaId(),
                    estudiosMapperCli.fromAdapterToDomainCli(estudiosModelCli, person, profession));
